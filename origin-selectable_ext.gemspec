...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://github.com/kristianmandrup/origin-selectable_ext"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.24"
  s.summary = "Extensions to Mongoid Origin selectable in order to support more dynamic queries"
